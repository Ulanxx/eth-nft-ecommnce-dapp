...
import logic from '../../../../business/user/account/profile_edit'
...
const schema_request = {
  ...
  required: ["companyName", "contactName", "contactEmail", "contactPhoneNumber"]
}
...
module.exports.action = async function (ctx) {
  ...
  if (role === constants.USER_ROLE_BRAND) {
    ...
    ctx.status = 401
    ctx.body = {code: -10, message: 'You are NOT a brand user'}
  }
}
